...
public interface TweenModelBuilder<AnimatorOperations> {
   ...
   */
  TweenModelBuilder<AnimatorOperations> addOval(
          String name,
          float cx, float cy,
   ...
   * @return the builder object
   */
  TweenModelBuilder<AnimatorOperations> addRectangle(
          String name,
          float lx, float ly,
   ...
   */
  TweenModelBuilder<AnimatorOperations> addMove(
          String name,
   ...
   */
  TweenModelBuilder<AnimatorOperations> addColorChange(
          String name,
   ...
   */
  TweenModelBuilder<AnimatorOperations> addScaleToChange(String name, float fromSx, float
